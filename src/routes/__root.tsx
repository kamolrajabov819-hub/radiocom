...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Radiocom — Motorola, Hytera & PoC Radios in Uzbekistan" },
      { name: "description", content: "Uzbekistan's leading distributor of professional radio systems. Motorola, Hytera, Radiocom RC. Authorized service center, PoC networks, rental & trade-in." },
      { property: "og:title", content: "Radiocom — Unbreakable Communication" },
      { property: "og:description", content: "11 years on the market. 10,000+ clients. Motorola, Hytera and PoC radio systems across Uzbekistan." },
